        ...
        <div className="svc-secondary-grid">
          <div className="svc-card fade-up d1">
            <div className="svc-card-top">
              <div className="svc-card-icon teal"><IconHeart /></div>
              <div className="svc-badge dark">Al detalle</div>
            </div>
            <h3 className="svc-card-title">Joyería Te Quiero</h3>
            <p className="svc-card-desc">
              Compra y venta de joyas al detalle, piezas únicas y metales
              preciosos para el consumidor final.
            </p>
            <a href="https://www.joyeriatequiero.com" target="_blank" rel="noopener noreferrer" className="svc-link">
              joyeriatequiero.com
          ...
          <div className="svc-card fade-up d2">
            <div className="svc-card-top">
            ...
            <a href="#contacto" className="svc-link">
              Solicitar catálogo
              <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path d="M5 12h14M12 5l7 7-7 7" />
              </svg>
